...
namespace DXUwpApplication1
{
    ...
    public sealed partial class CoverPage : DXPage
    {
        ...
        private async void CoverPageFileNotesSave_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            try
            {
        ...
        private async void BtnCoverPageNew_Click(object sender, RoutedEventArgs e)
        {
            try
            {
        ...
        private async void BtnCoverPagePDF_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                LoadingIndicator.IsActive = true;
        ...
        private void LongOperationAsync()
        {
            ...
            string filePathName = ApplicationData.Current.LocalFolder.Path + @"\Documents\" + fileName + ".docx";
            string templatePath = ApplicationData.Current.LocalFolder.Path + @"\temp.docx";
        ...
        private async void SavePDF(Stream outputStream, string fileName)
        {
            ...
            //else
            //{
            string folderPath = ApplicationData.Current.LocalFolder.Path + @"\Documents";
