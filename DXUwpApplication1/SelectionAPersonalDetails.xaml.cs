...
namespace DXUwpApplication1
{
    ...
    /// </summary>
    public sealed partial class SelectionAPersonalDetails : DXPage
    {
        public SelectionAPersonalDetails()
        {
            ...
            myInkCanvasFileNotesClientsParents.InkPresenter.InputDeviceTypes =
                Windows.UI.Core.CoreInputDeviceTypes.Mouse |
                Windows.UI.Core.CoreInputDeviceTypes.Pen;
        }
        ...
        private async void BtnCanvasFileNotes_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            try
            {
                ...
                var dialog = new MessageDialog("Selection A - Personal Details data saved successfully.", "Successful");
