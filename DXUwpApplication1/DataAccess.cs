...
namespace DXUwpApplication1
{
    public class DataAccess
    {
        ...
        public async static void InitializeDatabaseCreate()
        {
            try
            {
            ...
            if (!File.Exists(dbpath))
            {
                ...
                string desiredNameDocuments = "Documents";
                StorageFolder newFolderDocuments =
                    await localFolder.CreateFolderAsync(desiredNameDocuments, CreationCollisionOption.FailIfExists);

                var fileCopy = await StorageFile.GetFileFromApplicationUriAsync(new Uri("ms-appx:///Documents/temp.docx"));
                if (fileCopy != null)
                {
                    ...
                    await fileCopy.CopyAsync(ApplicationData.Current.LocalFolder);

                    //// Get path of newly created file
                    //String newFile = ApplicationData.Current.LocalFolder.Path + "/Documents/temp.docx";
                }

                var imageLogoCopy = await StorageFile.GetFileFromApplicationUriAsync(new Uri("ms-appx:///Documents/logo-1.png"));
                if (imageLogoCopy != null)
                {
                    await imageLogoCopy.CopyAsync(ApplicationData.Current.LocalFolder);
                }

                string desiredNameFileNotes = "FileNotes";
                StorageFolder newFolderFileNotes =
                    await localFolder.CreateFolderAsync(desiredNameFileNotes, CreationCollisionOption.FailIfExists);
                   ...
                   new SqliteConnection($"Filename={dbpath}"))
                {
                    ...
                    #region CoverPage
                    String tableCoverPage = "CREATE TABLE IF NOT " +
                        "EXISTS CoverPage (ID INTEGER PRIMARY KEY, " +
                        "PreparedFor NVARCHAR(2048) NULL, " +
                        "YourAdviser NVARCHAR(2048) NULL," +
                        "DateValue DATE NULL," +
                        //File Notes
                        "FileNotes_FileName NVARCHAR(2048) NULL, " +
                        "FileNotes_FilePath NVARCHAR(2048) NULL " +
                        ")";
                    SqliteCommand createTable = new SqliteCommand(tableCoverPage, db);
                    createTable.ExecuteReader();
                    #endregion

                    #region Selection A Personal Details
                    String tableSelectionAPersonalDetails = "CREATE TABLE IF NOT " +
                        "EXISTS SelectionAPersonalDetails (ID INTEGER PRIMARY KEY, " +
                        "CoverPageID INT NULL, " +
                        //Personal Details
                        "SurnameMaidenName_Client1 NVARCHAR(2048) NULL, " +
                        "SurnameMaidenName_Client2 NVARCHAR(2048) NULL, " +
                        "Givennames_Client1 NVARCHAR(2048) NULL, " +
                        "Givennames_Client2 NVARCHAR(2048) NULL, " +
                        "Preferredshortname_Client1 NVARCHAR(2048) NULL, " +
                        "Preferredshortname_Client2 NVARCHAR(2048) NULL, " +
                        "TitleMrMrsMsSirDr_Client1 NVARCHAR(2048) NULL, " +
                        "TitleMrMrsMsSirDr_Client2 NVARCHAR(2048) NULL, " +
                        "Gender_Client1 INT NULL, " + //1:Male 2:Female
                        "Gender_Client2 INT NULL, " + //1:Male 2:Female
                        "DateOfBirth_Client1 DATE NULL, " +
                        "DateOfBirth_Client2 DATE NULL, " +
                        "Age_Client1 INT NULL, " +
                        "Age_Client2 INT NULL, " +
                        "Maritalstatus_Client1 INT NULL, " + //1:Married 2:Divorced 3:Single 4:Widow(ed) 5:De facto 6:Unknown
                        "Maritalstatus_Client2 INT NULL, " + //1:Married 2:Divorced 3:Single 4:Widow(ed) 5:De facto 6:Unknown
                        "Health_Client1 INT NULL, " + //1:Excellent 2:Poor 3:Good 4:Unknown
                        "Health_Client2 INT NULL, " + //1:Excellent 2:Poor 3:Good 4:Unknown
                        "Smoker_Client1 INT NULL, " + //1:Yes 2:No
                        "Smoker_Client2 INT NULL, " + //1:Yes 2:No
                        "TownOfBirth_Client1 NVARCHAR(2048) NULL, " +
                        "TownOfBirth_Client2 NVARCHAR(2048) NULL, " +
                        "CountryOfBirth_Client1 NVARCHAR(2048) NULL, " +
                        "CountryOfBirth_Client2 NVARCHAR(2048) NULL, " +
                        "IfnotAustraliayearsinAustralia_Client1 NVARCHAR(2048) NULL, " +
                        "IfnotAustraliayearsinAustralia_Client2 NVARCHAR(2048) NULL, " +
                        "Areyouanonresident_Client1 NVARCHAR(2048) NULL, " +
                        "Areyouanonresident_Client2 NVARCHAR(2048) NULL, " +
                        "Taxfilenumber_Client1 NVARCHAR(2048) NULL, " +
                        "Taxfilenumber_Client2 NVARCHAR(2048) NULL, " +
                        "Wereyoureferredtous_Client1 NVARCHAR(2048) NULL, " +
                        "Wereyoureferredtous_Client2 NVARCHAR(2048) NULL, " +
                        "Haveyouworkedwithanotheradviser_Client1 NVARCHAR(2048) NULL, " +
                        "Haveyouworkedwithanotheradviser_Client2 NVARCHAR(2048) NULL, " +
                        "Areyouaresidentofanothercountryfortaxpurposes_Client1 NVARCHAR(2048) NULL, " +
                        "Areyouaresidentofanothercountryfortaxpurposes_Client2 NVARCHAR(2048) NULL, " +
                        "Ifyescountryofresidence_Client1 NVARCHAR(2048) NULL, " +
                        "Ifyescountryofresidence_Client2 NVARCHAR(2048) NULL, " +
                        "TaxidentificationnumberTINofforeigncountry_Client1 NVARCHAR(2048) NULL, " +
                        "TaxidentificationnumberTINofforeigncountry_Client2 NVARCHAR(2048) NULL, " +
                        "Areyouapoliticallyexposedperson_Client1 NVARCHAR(2048) NULL, " +
                        "Areyouapoliticallyexposedperson_Client2 NVARCHAR(2048) NULL, " +
                        //Contact Details
                        "Addresspostal_Client1 NVARCHAR(2048) NULL, " +
                        "Addresspostal_Client2 NVARCHAR(2048) NULL, " +
                        "Addresspostal2_Client1 NVARCHAR(2048) NULL, " +
                        "Addresspostal2_Client2 NVARCHAR(2048) NULL, " +
                        "AddresspostalState_Client1 NVARCHAR(2048) NULL, " +
                        "AddresspostalState_Client2 NVARCHAR(2048) NULL, " +
                        "AddresspostalPostcode_Client1 NVARCHAR(2048) NULL, " +
                        "AddresspostalPostcode_Client2 NVARCHAR(2048) NULL, " +
                        "Addressresidentialother_Client1 NVARCHAR(2048) NULL, " +
                        "Addressresidentialother_Client2 NVARCHAR(2048) NULL, " +
                        "AddressresidentialotherState_Client1 NVARCHAR(2048) NULL, " +
                        "AddressresidentialotherState_Client2 NVARCHAR(2048) NULL, " +
                        "AddressresidentialotherPostcode_Client1 NVARCHAR(2048) NULL, " +
                        "AddressresidentialotherPostcode_Client2 NVARCHAR(2048) NULL, " +
                        "Emailaddress_Client1 NVARCHAR(2048) NULL, " +
                        "Emailaddress_Client2 NVARCHAR(2048) NULL, " +
                        "Contactnumbersmainnumber_Client1 NVARCHAR(2048) NULL, " +
                        "Contactnumbersmainnumber_Client2 NVARCHAR(2048) NULL, " +
                        "Officephone_Client1 NVARCHAR(2048) NULL, " +
                        "Officephone_Client2 NVARCHAR(2048) NULL, " +
                        "Mobile_Client1 NVARCHAR(2048) NULL, " +
                        "Mobile_Client2 NVARCHAR(2048) NULL, " +
                        "Fax_Client1 NVARCHAR(2048) NULL, " +
                        "Fax_Client2 NVARCHAR(2048) NULL, " +
                        //Dependants
                        "SurnameName_Dependant1 NVARCHAR(2048) NULL, " +
                        "SurnameName_Dependant2 NVARCHAR(2048) NULL, " +
                        "SurnameName_Dependant3 NVARCHAR(2048) NULL, " +
                        "GivenNames_Dependant1 NVARCHAR(2048) NULL, " +
                        "GivenNames_Dependant2 NVARCHAR(2048) NULL, " +
                        "GivenNames_Dependant3 NVARCHAR(2048) NULL, " +
                        "PreferredShortName_Dependant1 NVARCHAR(2048) NULL, " +
                        "PreferredShortName_Dependant2 NVARCHAR(2048) NULL, " +
                        "PreferredShortName_Dependant3 NVARCHAR(2048) NULL, " +
                        "Title_Dependant1 NVARCHAR(2048) NULL, " +
                        "Title_Dependant2 NVARCHAR(2048) NULL, " +
                        "Title_Dependant3 NVARCHAR(2048) NULL, " +
                        "GenderMale_Dependant1 INT NULL, " + //1:Male 2:Female
                        "GenderMale_Dependant2 INT NULL, " + //1:Male 2:Female
                        "GenderMale_Dependant3 INT NULL, " + //1:Male 2:Female
                        "DateOfBirth_Dependant1 DATE NULL, " +
                        "DateOfBirth_Dependant2 DATE NULL, " +
                        "DateOfBirth_Dependant3 DATE NULL, " +
                        "Age_Dependant1 INT NULL, " +
                        "Age_Dependant2 INT NULL, " +
                        "Age_Dependant3 INT NULL, " +
                        "Relationship_Dependant1 NVARCHAR(2048) NULL, " +
                        "Relationship_Dependant2 NVARCHAR(2048) NULL, " +
                        "Relationship_Dependant3 NVARCHAR(2048) NULL, " +
                        "SpecialNeeds_Dependant1 INT NULL, " + //1:Yes 2:No
                        "SpecialNeeds_Dependant2 INT NULL, " +//1:Yes 2:No
                        "SpecialNeeds_Dependant3 INT NULL, " +//1:Yes 2:No
                        "Details_Dependant1 NVARCHAR(2048) NULL, " +
                        "Details_Dependant2 NVARCHAR(2048) NULL, " +
                        "Details_Dependant3 NVARCHAR(2048) NULL, " +
                        "Details2_Dependant1 NVARCHAR(2048) NULL, " +
                        "Details2_Dependant2 NVARCHAR(2048) NULL, " +
                        "Details2_Dependant3 NVARCHAR(2048) NULL, " +
                        "Details3_Dependant1 NVARCHAR(2048) NULL, " +
                        "Details3_Dependant2 NVARCHAR(2048) NULL, " +
                        "Details3_Dependant3 NVARCHAR(2048) NULL, " +
                        "Supporttoage_Dependant1 NVARCHAR(2048) NULL, " +
                        "Supporttoage_Dependant2 NVARCHAR(2048) NULL, " +
                        "Supporttoage_Dependant3 NVARCHAR(2048) NULL, " +
                        "SchoolName_Dependant1 NVARCHAR(2048) NULL, " +
                        "SchoolName_Dependant2 NVARCHAR(2048) NULL, " +
                        "SchoolName_Dependant3 NVARCHAR(2048) NULL, " +
                        "SchoolYearLevel_Dependant1 NVARCHAR(2048) NULL, " +
                        "SchoolYearLevel_Dependant2 NVARCHAR(2048) NULL, " +
                        "SchoolYearLevel_Dependant3 NVARCHAR(2048) NULL, " +
                        "EstimatedCostofSchooling_Dependant1 NVARCHAR(2048) NULL, " +
                        "EstimatedCostofSchooling_Dependant2 NVARCHAR(2048) NULL, " +
                        "EstimatedCostofSchooling_Dependant3 NVARCHAR(2048) NULL, " +
                        "AustudyStatus_Dependant1 INT NULL, " +//1:Not claiming 2:Home 3:Away from home
                        "AustudyStatus_Dependant2 INT NULL, " +//1:Not claiming 2:Home 3:Away from home
                        "AustudyStatus_Dependant3 INT NULL, " +//1:Not claiming 2:Home 3:Away from home
                                                               //Client's parents
                        "ClientsParents NVARCHAR(2048) NULL, " +
                        //File Notes
                        "FileNotesClientsParents_FileName NVARCHAR(2048) NULL, " +
                        "FileNotesClientsParents_FilePath NVARCHAR(2048) NULL, " +
                        //Special Interests
                        "EgCollectablesGolfTennis_Client1 NVARCHAR(2048) NULL, " +
                        "EgCollectablesGolfTennis_Client2 NVARCHAR(2048) NULL, " +
                        "EgCollectablesGolfTennis2_Client1 NVARCHAR(2048) NULL, " +
                        "EgCollectablesGolfTennis2_Client2 NVARCHAR(2048) NULL, " +
                        "EgCollectablesGolfTennis3_Client1 NVARCHAR(2048) NULL, " +
                        "EgCollectablesGolfTennis3_Client2 NVARCHAR(2048) NULL, " +
                        //Business Advisers
                        "Businessname_Accountant NVARCHAR(2048) NULL, " +
                        "Businessname_Banker NVARCHAR(2048) NULL, " +
                        "Businessname_Lawyer NVARCHAR(2048) NULL, " +
                        "Contactname_Accountant NVARCHAR(2048) NULL, " +
                        "Contactname_Banker NVARCHAR(2048) NULL, " +
                        "Contactname_Lawyer NVARCHAR(2048) NULL, " +
                        "Postaladdress_Accountant NVARCHAR(2048) NULL, " +
                        "Postaladdress_Banker NVARCHAR(2048) NULL, " +
                        "Postaladdress_Lawyer NVARCHAR(2048) NULL, " +
                        "Postaladdress2_Accountant NVARCHAR(2048) NULL, " +
                        "Postaladdress2_Banker NVARCHAR(2048) NULL, " +
                        "Postaladdress2_Lawyer NVARCHAR(2048) NULL, " +
                        "PostaladdressState_Accountant NVARCHAR(2048) NULL, " +
                        "PostaladdressState_Banker NVARCHAR(2048) NULL, " +
                        "PostaladdressState_Lawyer NVARCHAR(2048) NULL, " +
                        "PostaladdressPostcode_Accountant NVARCHAR(2048) NULL, " +
                        "PostaladdressPostcode_Banker NVARCHAR(2048) NULL, " +
                        "PostaladdressPostcode_Lawyer NVARCHAR(2048) NULL, " +
                        "Emailaddress_Accountant NVARCHAR(2048) NULL, " +
                        "Emailaddress_Banker NVARCHAR(2048) NULL, " +
                        "Emailaddress_Lawyer NVARCHAR(2048) NULL, " +
                        "Phoneaddress_Accountant NVARCHAR(2048) NULL, " +
                        "Phoneaddress_Banker NVARCHAR(2048) NULL, " +
                        "Phoneaddress_Lawyer NVARCHAR(2048) NULL, " +
                        "Faxnumber_Accountant NVARCHAR(2048) NULL, " +
                        "Faxnumber_Banker NVARCHAR(2048) NULL, " +
                        "Faxnumber_Lawyer NVARCHAR(2048) NULL, " +
                        //File Notes
                        "FileNotes_FileName NVARCHAR(2048) NULL, " +
                        "FileNotes_FilePath NVARCHAR(2048) NULL " +

                        ")";
                    SqliteCommand createTable2 = new SqliteCommand(tableSelectionAPersonalDetails, db);
                    createTable2.ExecuteReader();
                    #endregion

                    #region Selection B Financial Summary
                    String tableSelectionBFinancialSummary = "CREATE TABLE IF NOT " +
                        "EXISTS SelectionBFinancialSummary (ID INTEGER PRIMARY KEY, " +
                        "CoverPageID INT NULL, " +
                        //Employment Details
                        "Workstatus_Client1 INT NULL, " + //1:Fully employed 2:Part time employed 3:Home duties 4:Self employed 5:Unemployed 6:Early Retirement 7:Retired 8:Student 9:Unknown
                        "Workstatus_Client2 INT NULL, " + //1:Fully employed 2:Part time employed 3:Home duties 4:Self employed 5:Unemployed 6:Early Retirement 7:Retired 8:Student 9:Unknown
                        "Employer_Client1 NVARCHAR(2048) NULL, " +
                        "Employer_Client2 NVARCHAR(2048) NULL, " +
                        "Employeraddress_Client1 NVARCHAR(2048) NULL, " +
                        "Employeraddress_Client2 NVARCHAR(2048) NULL, " +
                        "Occupation_Client1 NVARCHAR(2048) NULL, " +
                        "Occupation_Client2 NVARCHAR(2048) NULL, " +
                        "Numberofyearsservice_Client1 NVARCHAR(2048) NULL, " +
                        "Numberofyearsservice_Client2 NVARCHAR(2048) NULL, " +
                        "IntendedRetirementdate_Client1 NVARCHAR(2048) NULL, " +
                        "IntendedRetirementdate_Client2 NVARCHAR(2048) NULL, " +
                        "Doyouexpectemployment_Client1 NVARCHAR(2048) NULL, " +
                        "Doyouexpectemployment_Client2 NVARCHAR(2048) NULL, " +
                        //Salary & Other Income
                        "Salaryincome_Client1 NVARCHAR(2048) NULL, " +
                        "Salaryincome_Client2 NVARCHAR(2048) NULL, " +
                        "Othertaxableincome_Client1 NVARCHAR(2048) NULL, " +
                        "Othertaxableincome_Client2 NVARCHAR(2048) NULL, " +
                        "Taxfreeincome_Client1 NVARCHAR(2048) NULL, " +
                        "Taxfreeincome_Client2 NVARCHAR(2048) NULL, " +
                        "Familyallowance_Client1 NVARCHAR(2048) NULL, " +
                        "Familyallowance_Client2 NVARCHAR(2048) NULL, " +
                        "Directorsfeesgratuities_Client1 NVARCHAR(2048) NULL, " +
                        "Directorsfeesgratuities_Client2 NVARCHAR(2048) NULL, " +
                        "Areyouexpectingfunds1_Client1 NVARCHAR(2048) NULL, " +
                        "Areyouexpectingfunds1_Client2 NVARCHAR(2048) NULL, " +
                        "Areyouexpectingfunds2_Client1 NVARCHAR(2048) NULL, " +
                        "Areyouexpectingfunds2_Client2 NVARCHAR(2048) NULL, " +
                        "Areyouexpectingfunds3_Client1 NVARCHAR(2048) NULL, " +
                        "Areyouexpectingfunds3_Client2 NVARCHAR(2048) NULL, " +
                        "Other1_Client1 NVARCHAR(2048) NULL, " +
                        "Other1_Client2 NVARCHAR(2048) NULL, " +
                        "Other2_Client1 NVARCHAR(2048) NULL, " +
                        "Other2_Client2 NVARCHAR(2048) NULL, " +
                        "Other3_Client1 NVARCHAR(2048) NULL, " +
                        "Other3_Client2 NVARCHAR(2048) NULL, " +
                        //Salary Sacrifice / Package
                        "Employmentsuper_Client1 NVARCHAR(2048) NULL, " +
                        "Employmentsuper_Client2 NVARCHAR(2048) NULL, " +
                        "Salarysacrificetosuper_Client1 NVARCHAR(2048) NULL, " +
                        "Salarysacrificetosuper_Client2 NVARCHAR(2048) NULL, " +
                        "Packagedmotorvehicle_Client1 NVARCHAR(2048) NULL, " +
                        "Packagedmotorvehicle_Client2 NVARCHAR(2048) NULL, " +
                        "Bonus_Client1 NVARCHAR(2048) NULL, " +
                        "Bonus_Client2 NVARCHAR(2048) NULL, " +
                        "Other_Client1 NVARCHAR(2048) NULL, " +
                        "Other_Client2 NVARCHAR(2048) NULL, " +
                        //Centrelink
                        "Entitlementamount_Client1 NVARCHAR(2048) NULL, " +
                        "Entitlementamount_Client2 NVARCHAR(2048) NULL, " +
                        "Entitlementtype_Client1 NVARCHAR(2048) NULL, " +
                        "Entitlementtype_Client2 NVARCHAR(2048) NULL, " +
                        "CentrelinkreferencenoCRN_Client1 NVARCHAR(2048) NULL, " +
                        "CentrelinkreferencenoCRN_Client2 NVARCHAR(2048) NULL, " +
                        "Maintenanceincome_Client1 NVARCHAR(2048) NULL, " +
                        "Maintenanceincome_Client2 NVARCHAR(2048) NULL, " +
                        "Maintenancepayment_Client1 NVARCHAR(2048) NULL, " +
                        "Maintenancepayment_Client2 NVARCHAR(2048) NULL, " +
                        "Overseassocialsecurityincome_Client1 NVARCHAR(2048) NULL, " +
                        "Overseassocialsecurityincome_Client2 NVARCHAR(2048) NULL, " +
                        //Centrelink - File Notes
                        "FileNotesCentrelink_FileName NVARCHAR(2048) NULL, " +
                        "FileNotesCentrelink_FilePath NVARCHAR(2048) NULL, " +
                        //Cost of living
                        "Foodliquids_Fortnight NVARCHAR(2048) NULL, " +
                        "Foodliquids_Month NVARCHAR(2048) NULL, " +
                        "Foodliquids_Quarter NVARCHAR(2048) NULL, " +
                        "Foodliquids_Halfyear NVARCHAR(2048) NULL, " +
                        "Foodliquids_Annual NVARCHAR(2048) NULL, " +
                        "Foodliquids_Totallastyear NVARCHAR(2048) NULL, " +
                        "Alcohol_Fortnight NVARCHAR(2048) NULL, " +
                        "Alcohol_Month NVARCHAR(2048) NULL, " +
                        "Alcohol_Quarter NVARCHAR(2048) NULL, " +
                        "Alcohol_Halfyear NVARCHAR(2048) NULL, " +
                        "Alcohol_Annual NVARCHAR(2048) NULL, " +
                        "Alcohol_Totallastyear NVARCHAR(2048) NULL, " +
                        "Tobacco_Fortnight NVARCHAR(2048) NULL, " +
                        "Tobacco_Month NVARCHAR(2048) NULL, " +
                        "Tobacco_Quarter NVARCHAR(2048) NULL, " +
                        "Tobacco_Halfyear NVARCHAR(2048) NULL, " +
                        "Tobacco_Annual NVARCHAR(2048) NULL, " +
                        "Tobacco_Totallastyear NVARCHAR(2048) NULL, " +
                        "Clothingfootwear_Fortnight NVARCHAR(2048) NULL, " +
                        "Clothingfootwear_Month NVARCHAR(2048) NULL, " +
                        "Clothingfootwear_Quarter NVARCHAR(2048) NULL, " +
                        "Clothingfootwear_Halfyear NVARCHAR(2048) NULL, " +
                        "Clothingfootwear_Annual NVARCHAR(2048) NULL, " +
                        "Clothingfootwear_Totallastyear NVARCHAR(2048) NULL, " +
                        "Medicalhealth_Fortnight NVARCHAR(2048) NULL, " +
                        "Medicalhealth_Month NVARCHAR(2048) NULL, " +
                        "Medicalhealth_Quarter NVARCHAR(2048) NULL, " +
                        "Medicalhealth_Halfyear NVARCHAR(2048) NULL, " +
                        "Medicalhealth_Annual NVARCHAR(2048) NULL, " +
                        "Medicalhealth_Totallastyear NVARCHAR(2048) NULL, " +
                        "Recreation_Fortnight NVARCHAR(2048) NULL, " +
                        "Recreation_Month NVARCHAR(2048) NULL, " +
                        "Recreation_Quarter NVARCHAR(2048) NULL, " +
                        "Recreation_Halfyear NVARCHAR(2048) NULL, " +
                        "Recreation_Annual NVARCHAR(2048) NULL, " +
                        "Recreation_Totallastyear NVARCHAR(2048) NULL, " +
                        "Personalcare_Fortnight NVARCHAR(2048) NULL, " +
                        "Personalcare_Month NVARCHAR(2048) NULL, " +
                        "Personalcare_Quarter NVARCHAR(2048) NULL, " +
                        "Personalcare_Halfyear NVARCHAR(2048) NULL, " +
                        "Personalcare_Annual NVARCHAR(2048) NULL, " +
                        "Personalcare_Totallastyear NVARCHAR(2048) NULL, " +
                        "PhonePost_Fortnight NVARCHAR(2048) NULL, " +
                        "PhonePost_Month NVARCHAR(2048) NULL, " +
                        "PhonePost_Quarter NVARCHAR(2048) NULL, " +
                        "PhonePost_Halfyear NVARCHAR(2048) NULL, " +
                        "PhonePost_Annual NVARCHAR(2048) NULL, " +
                        "PhonePost_Totallastyear NVARCHAR(2048) NULL, " +
                        "Travel_Fortnight NVARCHAR(2048) NULL, " +
                        "Travel_Month NVARCHAR(2048) NULL, " +
                        "Travel_Quarter NVARCHAR(2048) NULL, " +
                        "Travel_Halfyear NVARCHAR(2048) NULL, " +
                        "Travel_Annual NVARCHAR(2048) NULL, " +
                        "Travel_Totallastyear NVARCHAR(2048) NULL, " +
                        "Gifts_Fortnight NVARCHAR(2048) NULL, " +
                        "Gifts_Month NVARCHAR(2048) NULL, " +
                        "Gifts_Quarter NVARCHAR(2048) NULL, " +
                        "Gifts_Halfyear NVARCHAR(2048) NULL, " +
                        "Gifts_Annual NVARCHAR(2048) NULL, " +
                        "Gifts_Totallastyear NVARCHAR(2048) NULL, " +
                        "Other_Fortnight NVARCHAR(2048) NULL, " +
                        "Other_Month NVARCHAR(2048) NULL, " +
                        "Other_Quarter NVARCHAR(2048) NULL, " +
                        "Other_Halfyear NVARCHAR(2048) NULL, " +
                        "Other_Annual NVARCHAR(2048) NULL, " +
                        "Other_Totallastyear NVARCHAR(2048) NULL, " +
                        "Ratesinsurance_Fortnight NVARCHAR(2048) NULL, " +
                        "Ratesinsurance_Month NVARCHAR(2048) NULL, " +
                        "Ratesinsurance_Quarter NVARCHAR(2048) NULL, " +
                        "Ratesinsurance_Halfyear NVARCHAR(2048) NULL, " +
                        "Ratesinsurance_Annual NVARCHAR(2048) NULL, " +
                        "Ratesinsurance_Totallastyear NVARCHAR(2048) NULL, " +

                        "Repairsmaintenance_Fortnight NVARCHAR(2048) NULL, " +
                        "Repairsmaintenance_Month NVARCHAR(2048) NULL, " +
                        "Repairsmaintenance_Quarter NVARCHAR(2048) NULL, " +
                        "Repairsmaintenance_Halfyear NVARCHAR(2048) NULL, " +
                        "Repairsmaintenance_Annual NVARCHAR(2048) NULL, " +
                        "Repairsmaintenance_Totallastyear NVARCHAR(2048) NULL, " +

                        "Electricitygas_Fortnight NVARCHAR(2048) NULL, " +
                        "Electricitygas_Month NVARCHAR(2048) NULL, " +
                        "Electricitygas_Quarter NVARCHAR(2048) NULL, " +
                        "Electricitygas_Halfyear NVARCHAR(2048) NULL, " +
                        "Electricitygas_Annual NVARCHAR(2048) NULL, " +
                        "Electricitygas_Totallastyear NVARCHAR(2048) NULL, " +

                        "Houseloanprincipal_Fortnight NVARCHAR(2048) NULL, " +
                        "Houseloanprincipal_Month NVARCHAR(2048) NULL, " +
                        "Houseloanprincipal_Quarter NVARCHAR(2048) NULL, " +
                        "Houseloanprincipal_Halfyear NVARCHAR(2048) NULL, " +
                        "Houseloanprincipal_Annual NVARCHAR(2048) NULL, " +
                        "Houseloanprincipal_Totallastyear NVARCHAR(2048) NULL, " +

                        "Rentmortgage_Fortnight NVARCHAR(2048) NULL, " +
                        "Rentmortgage_Month NVARCHAR(2048) NULL, " +
                        "Rentmortgage_Quarter NVARCHAR(2048) NULL, " +
                        "Rentmortgage_Halfyear NVARCHAR(2048) NULL, " +
                        "Rentmortgage_Annual NVARCHAR(2048) NULL, " +
                        "Rentmortgage_Totallastyear NVARCHAR(2048) NULL, " +

                        "Extramortgagepayments_Fortnight NVARCHAR(2048) NULL, " +
                        "Extramortgagepayments_Month NVARCHAR(2048) NULL, " +
                        "Extramortgagepayments_Quarter NVARCHAR(2048) NULL, " +
                        "Extramortgagepayments_Halfyear NVARCHAR(2048) NULL, " +
                        "Extramortgagepayments_Annual NVARCHAR(2048) NULL, " +
                        "Extramortgagepayments_Totallastyear NVARCHAR(2048) NULL, " +

                        "Furnishingequipment_Fortnight NVARCHAR(2048) NULL, " +
                        "Furnishingequipment_Month NVARCHAR(2048) NULL, " +
                        "Furnishingequipment_Quarter NVARCHAR(2048) NULL, " +
                        "Furnishingequipment_Halfyear NVARCHAR(2048) NULL, " +
                        "Furnishingequipment_Annual NVARCHAR(2048) NULL, " +
                        "Furnishingequipment_Totallastyear NVARCHAR(2048) NULL, " +

                        "OtherHousing_Fortnight NVARCHAR(2048) NULL, " +
                        "OtherHousing_Month NVARCHAR(2048) NULL, " +
                        "OtherHousing_Quarter NVARCHAR(2048) NULL, " +
                        "OtherHousing_Halfyear NVARCHAR(2048) NULL, " +
                        "OtherHousing_Annual NVARCHAR(2048) NULL, " +
                        "OtherHousing_Totallastyear NVARCHAR(2048) NULL, " +

                        "Registrationinsurance_Fortnight NVARCHAR(2048) NULL, " +
                        "Registrationinsurance_Month NVARCHAR(2048) NULL, " +
                        "Registrationinsurance_Quarter NVARCHAR(2048) NULL, " +
                        "Registrationinsurance_Halfyear NVARCHAR(2048) NULL, " +
                        "Registrationinsurance_Annual NVARCHAR(2048) NULL, " +
                        "Registrationinsurance_Totallastyear NVARCHAR(2048) NULL, " +

                        "RepairsmaintenanceTransport_Fortnight NVARCHAR(2048) NULL, " +
                        "RepairsmaintenanceTransport_Month NVARCHAR(2048) NULL, " +
                        "RepairsmaintenanceTransport_Quarter NVARCHAR(2048) NULL, " +
                        "RepairsmaintenanceTransport_Halfyear NVARCHAR(2048) NULL, " +
                        "RepairsmaintenanceTransport_Annual NVARCHAR(2048) NULL, " +
                        "RepairsmaintenanceTransport_Totallastyear NVARCHAR(2048) NULL, " +

                        "FuelOil_Fortnight NVARCHAR(2048) NULL, " +
                        "FuelOil_Month NVARCHAR(2048) NULL, " +
                        "FuelOil_Quarter NVARCHAR(2048) NULL, " +
                        "FuelOil_Halfyear NVARCHAR(2048) NULL, " +
                        "FuelOil_Annual NVARCHAR(2048) NULL, " +
                        "FuelOil_Totallastyear NVARCHAR(2048) NULL, " +

                        "Replacementvehicle_Fortnight NVARCHAR(2048) NULL, " +
                        "Replacementvehicle_Month NVARCHAR(2048) NULL, " +
                        "Replacementvehicle_Quarter NVARCHAR(2048) NULL, " +
                        "Replacementvehicle_Halfyear NVARCHAR(2048) NULL, " +
                        "Replacementvehicle_Annual NVARCHAR(2048) NULL, " +
                        "Replacementvehicle_Totallastyear NVARCHAR(2048) NULL, " +

                        "Fares_Fortnight NVARCHAR(2048) NULL, " +
                        "Fares_Month NVARCHAR(2048) NULL, " +
                        "Fares_Quarter NVARCHAR(2048) NULL, " +
                        "Fares_Halfyear NVARCHAR(2048) NULL, " +
                        "Fares_Annual NVARCHAR(2048) NULL, " +
                        "Fares_Totallastyear NVARCHAR(2048) NULL, " +

                        "OtherTransport_Fortnight NVARCHAR(2048) NULL, " +
                        "OtherTransport_Month NVARCHAR(2048) NULL, " +
                        "OtherTransport_Quarter NVARCHAR(2048) NULL, " +
                        "OtherTransport_Halfyear NVARCHAR(2048) NULL, " +
                        "OtherTransport_Annual NVARCHAR(2048) NULL, " +
                        "OtherTransport_Totallastyear NVARCHAR(2048) NULL, " +

                        "Superlifeinsurance_Fortnight NVARCHAR(2048) NULL, " +
                        "Superlifeinsurance_Month NVARCHAR(2048) NULL, " +
                        "Superlifeinsurance_Quarter NVARCHAR(2048) NULL, " +
                        "Superlifeinsurance_Halfyear NVARCHAR(2048) NULL, " +
                        "Superlifeinsurance_Annual NVARCHAR(2048) NULL, " +
                        "Superlifeinsurance_Totallastyear NVARCHAR(2048) NULL, " +

                        "Loansavings_Fortnight NVARCHAR(2048) NULL, " +
                        "Loansavings_Month NVARCHAR(2048) NULL, " +
                        "Loansavings_Quarter NVARCHAR(2048) NULL, " +
                        "Loansavings_Halfyear NVARCHAR(2048) NULL, " +
                        "Loansavings_Annual NVARCHAR(2048) NULL, " +
                        "Loansavings_Totallastyear NVARCHAR(2048) NULL, " +

                        "Carloan_Fortnight NVARCHAR(2048) NULL, " +
                        "Carloan_Month NVARCHAR(2048) NULL, " +
                        "Carloan_Quarter NVARCHAR(2048) NULL, " +
                        "Carloan_Halfyear NVARCHAR(2048) NULL, " +
                        "Carloan_Annual NVARCHAR(2048) NULL, " +
                        "Carloan_Totallastyear NVARCHAR(2048) NULL, " +

                        "OtherGeneral_Fortnight NVARCHAR(2048) NULL, " +
                        "OtherGeneral_Month NVARCHAR(2048) NULL, " +
                        "OtherGeneral_Quarter NVARCHAR(2048) NULL, " +
                        "OtherGeneral_Halfyear NVARCHAR(2048) NULL, " +
                        "OtherGeneral_Annual NVARCHAR(2048) NULL, " +
                        "OtherGeneral_Totallastyear NVARCHAR(2048) NULL, " +

                        "Foodliquid_Fortnight NVARCHAR(2048) NULL, " +
                        "Foodliquid_Month NVARCHAR(2048) NULL, " +
                        "Foodliquid_Quarter NVARCHAR(2048) NULL, " +
                        "Foodliquid_Halfyear NVARCHAR(2048) NULL, " +
                        "Foodliquid_Annual NVARCHAR(2048) NULL, " +
                        "Foodliquid_Totallastyear NVARCHAR(2048) NULL, " +

                        "ClothingfootwearChildren_Fortnight NVARCHAR(2048) NULL, " +
                        "ClothingfootwearChildren_Month NVARCHAR(2048) NULL, " +
                        "ClothingfootwearChildren_Quarter NVARCHAR(2048) NULL, " +
                        "ClothingfootwearChildren_Halfyear NVARCHAR(2048) NULL, " +
                        "ClothingfootwearChildren_Annual NVARCHAR(2048) NULL, " +
                        "ClothingfootwearChildren_Totallastyear NVARCHAR(2048) NULL, " +

                        "Education_Fortnight NVARCHAR(2048) NULL, " +
                        "Education_Month NVARCHAR(2048) NULL, " +
                        "Education_Quarter NVARCHAR(2048) NULL, " +
                        "Education_Halfyear NVARCHAR(2048) NULL, " +
                        "Education_Annual NVARCHAR(2048) NULL, " +
                        "Education_Totallastyear NVARCHAR(2048) NULL, " +

                        "OtherChildren_Fortnight NVARCHAR(2048) NULL, " +
                        "OtherChildren_Month NVARCHAR(2048) NULL, " +
                        "OtherChildren_Quarter NVARCHAR(2048) NULL, " +
                        "OtherChildren_Halfyear NVARCHAR(2048) NULL, " +
                        "OtherChildren_Annual NVARCHAR(2048) NULL, " +
                        "OtherChildren_Totallastyear NVARCHAR(2048) NULL, " +

                        "Total_Fortnight NVARCHAR(2048) NULL, " +
                        "Total_Month NVARCHAR(2048) NULL, " +
                        "Total_Quarter NVARCHAR(2048) NULL, " +
                        "Total_Halfyear NVARCHAR(2048) NULL, " +
                        "Total_Annual NVARCHAR(2048) NULL, " +
                        "Total_Totallastyear NVARCHAR(2048) NULL, " +
                    ...
                    "FileNotes_FileName NVARCHAR(2048) NULL, " +
                        ...
                        ")";
                    SqliteCommand createTable3 = new SqliteCommand(tableSelectionBFinancialSummary, db);
